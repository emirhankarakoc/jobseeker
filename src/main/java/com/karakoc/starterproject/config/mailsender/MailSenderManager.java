...
public class MailSenderManager implements MailSenderService {
    ...
    public String forgotPassword(String mail) {
        ...
        simpleMailMessage.setText("Hello Mr/Mrs ".toUpperCase() + user.getFirstname().toUpperCase() + ", we got a forgot request.\nYour new password: " + password + "\n\n!!!!!...Don't forget change your password after log in with new password...!!!!!!!");
        repository.save(user);
        mailSender.send(simpleMailMessage);
        return "Mr/Mrs. " + user.getFirstname().toUpperCase() + " , new password sent to your mail adress. Please check your mailbox.\n\n!!!!!...Don't forget change your password after log in with new password....!!!!!!!";
